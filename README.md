...
```
    ...
    What's the value of the shot: 1
            Player 1: score 50, potential score 92
            Player 2: score 25, potential score 60
    Break: 25
    1 red balls left
    ...
    Active player: Player 2
            Player 1: score 50, potential score 77
            Player 2: score 25, potential score 52

Done: Player 2 must pot yellow ball, not any color
    What's the value of the shot: 2
            Player 1: score 50, potential score 77
            Player 2: score 27, potential score 47
    Player 2 needs snookers!

Done: Player 2 must pot yellow ball, not any color
    What's the value of the shot: 2
            Player 1: score 50, potential score 77
            Player 2: score 29, potential score 42
    Player 2 must pot a yellow ball

Done: potential score jumps from 42 to 56
Note: 56 = 52 (correct pot score) + 2 + 2 (balls potted before end_break)
Note: 42 = 52 - (7 - 2) - (7 - 2) 
    What's the value of the shot: 2
            Player 1: score 50, potential score 75
            Player 2: score 31, potential score 56
    Player 2 must pot a green ball

    What's the value of the shot: 3
            Player 1: score 50, potential score 72
            Player 2: score 34, potential score 56
    Player 2 must pot a brown ball

    What's the value of the shot: 4
            Player 1: score 50, potential score 68
            Player 2: score 38, potential score 56
    Player 2 must pot a blue ball

    What's the value of the shot: 5
            Player 1: score 50, potential score 63
            Player 2: score 43, potential score 56
    Player 2 must pot a pink ball

    What's the value of the shot: 6
            Player 1: score 50, potential score 57
            Player 2: score 49, potential score 56
    Break: 24
    Player 2 must pot a black ball

    What's the value of the shot: 7
            Player 1: score 50, potential score 50
            Player 2: score 56, potential score 56
    Break: 31
```
