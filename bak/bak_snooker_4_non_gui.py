...
# Note: Code after conversations with chatgpt
# Reverted to the original code, but kept the changes in this file
...
class SnookerScores:
    def __init__(self):
        ...
        self.last_shot = 0  # Initialize with 0
    ...
    def handle_color_ball(self, shot):
        ...
        if self.red_needed_next:
            ...
            if self.player_1_turn:
                print(f"Available 1 before: {self.available_player_1}")
                self.available_player_1 -= (7 - shot)
                print(f"Available 1 after: {self.available_player_1}")
            else:
                print(f"Available 2 before: {self.available_player_2}")
                self.available_player_2 -= (7 - shot)
                print(f"Available 2 after: {self.available_player_2}")

            self.update_score(shot)  # Update score first
            self.red_needed_next = True
            self.calculate_possible_scores()  # Now update possible scores
    ...
    def calculate_possible_scores(self):
        ...
        print(f"DEBUG: Before calculating scores - P1 Score: {self.score_player_1}, Available P1: {self.available_player_1}")
        print(f"DEBUG: Before calculating scores - P2 Score: {self.score_player_2}, Available P2: {self.available_player_2}")

        self.possible_score_player_1 = self.score_player_1 + self.available_player_1
        self.possible_score_player_2 = self.score_player_2 + self.available_player_2

        print(f"DEBUG: Updated possible scores - P1: {self.possible_score_player_1}, P2: {self.possible_score_player_2}")
